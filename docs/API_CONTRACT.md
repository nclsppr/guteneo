...
| `409`         | `IDEMPOTENCY_CONFLICT`, `APPROVAL_REQUIRED`, `FINGERPRINT_MISMATCH`, `QUOTA_EXCEEDED`, `CHANNEL_DISABLED`, `CAMPAIGN_FROZEN`, `RECIPIENT_SUPPRESSED`, `LIVE_PRICING_REQUIRED` : résoudre la condition métier avant une nouvelle tentative. |
