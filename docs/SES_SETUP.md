...
- The deployed signed webhook endpoint must be reachable. The current general configuration guard can return 503 before webhook verification when unrelated identity configuration is missing; qualify the actual endpoint before SNS subscription.
