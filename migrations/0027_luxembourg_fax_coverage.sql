-- Extend the explicit Luxembourg pilot to separately priced destination categories.
-- Preserve every existing tariff, quote, approval and financial hold byte-for-byte.
